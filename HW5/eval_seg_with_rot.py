...
if __name__ == '__main__':
    ...
    for batch in test_dataloader:
        ...
        for i in randints:
            ...
            viz_seg(point_clouds[i], labels[i], "{}/{}_gt.gif".format(args.output_dir, i), args.device)
            viz_seg(point_clouds[i], pred_labels[i], "{}/{}_pred.gif".format(args.output_dir, i), args.device)
