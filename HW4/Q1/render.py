...
def create_renders(args):
    ...
    for i in tqdm(range(num_views), desc="Rendering"):
        ...
        with torch.no_grad():
            ...
            """
            img, depth, mask = scene.render(camera, per_splat=args.gaussians_per_splat,
                                            img_size=img_size, bg_colour=(1.0, 1.0, 1.0))
...
if __name__ == "__main__":
    ...
    args = get_args()
    print("GAUSSIANS PER SPLAT:", args.gaussians_per_splat)
    print("IMG DIM:", args.img_dim)
    create_renders(args)
